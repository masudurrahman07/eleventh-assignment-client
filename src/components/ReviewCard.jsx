...
const ReviewCard = ({ review, onDelete, onUpdate }) => {
  ...
  return (
    <div className="bg-white rounded-xl p-5  shadow-lg flex flex-col h-full">
      ...
      <div className="mt-3 flex gap-2">
        <button
          onClick={onUpdate}
          className="px-3 py-1 bg-emerald-500 text-white rounded hover:bg-emerald-600"> Update</button>
