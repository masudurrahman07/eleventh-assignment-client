                  ...
                  <tr key={fav._id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-3 px-4">
                      <button
                        ...
                        className="bg-linear-to-r from-red-500 to-red-600 text-white px-4 py-2 rounded-lg shadow hover:from-red-600 hover:to-red-700 transition-all"> Delete </button>
                    </td>
                  </tr>))}
              </tbody>
            </table>
