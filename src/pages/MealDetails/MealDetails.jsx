// src/pages/MealDetails/MealDetails.jsx
...
const MealDetails = () => {
  ...
  const { user, token } = useAuth(); // ✅ use context correctly
    ...
    <div className="max-w-7xl mx-auto py-12 px-4 space-y-12">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 bg-white rounded-2xl p-8 shadow-xl space-y-6">
          ...
          <p>
            <strong>Chef Experience:</strong> {meal.chefExperience || 'Professional'}
          </p>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            ...
            <button
              ...
              className="px-8 py-3 bg-pink-500 text-white font-bold rounded-xl hover:bg-pink-600 transition flex items-center gap-2"
            >
