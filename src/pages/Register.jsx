  ...
  return (
    <div className="flex justify-center items-center h-[95vh] px-4 bg-gray-50">
      ...
      <motion.form
        ...
        <button
          type="submit"
          className="w-full bg-emerald-500 text-white py-3 rounded-lg text-lg font-semibold hover:bg-emerald-600 transition">Register</button>

        <p className="mt-5 text-center text-gray-600">Already have an account?{' '}
