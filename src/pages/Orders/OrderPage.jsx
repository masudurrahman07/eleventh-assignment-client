  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 space-y-10">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
        ...
        <div className="space-y-4">
          ...
          {[
            ...
            <div
              ...
              <div className="flex items-center gap-2"> {item.icon} <span className="text-gray-500 font-medium">{item.label}:</span> </div>
        ...
        <button
          type="submit"
          className="w-full py-3 bg-green-500 text-white font-bold rounded-2xl shadow-lg hover:bg-green-600 transition">Confirm & Place Order (${meal.price * parseInt(quantity, 10)})</button>
      </form>
    </div>
  );
};
