  ...
  return (
    <motion.section
      ...
      <motion.div
       ...
       <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-linear-to-r from-white/90 to-gray-200 bg-clip-text text-transparent drop-shadow-lg mb-2"> Welcome to LocalChefBazaar</h1>

<p className="text-base md:text-lg lg:text-xl bg-linear-to-r from-white/90 to-gray-200 bg-clip-text text-transparent drop-shadow-md max-w-2xl mb-4">Fresh, homemade meals from local chefs delivered to your doorstep.</p>
