        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-10">
          ...
          {user && (
            <button
              ...
              className="mt-4 md:mt-0 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white font-semibold shadow transition"><FaPlus /> Give Review</button>)}
        </div>
